...
import be.cetic.ddolibscala.examples.layered.tsptw.{Position, TimeWindow, TspNode, VirtualNodes}
...
/** Class representing an instance of the Traveling Salesperson Problem with Time Windows (TSPTW).
  ...
  * defined by a distance matrix. This class implements the [[be.cetic.ddolibscala.layered.modeling.Problem]]
