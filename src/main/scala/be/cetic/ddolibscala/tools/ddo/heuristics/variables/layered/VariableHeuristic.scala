package be.cetic.ddolibscala.tools.ddo.heuristics.variables.layered
...
/** Defines a strategy for selecting the next decision variable to branch on during the construction
  ...
  */
trait VariableHeuristic[T] extends org.ddolib.layered.solving.ddo.core.heuristics.variable.VariableHeuristic[T] {
